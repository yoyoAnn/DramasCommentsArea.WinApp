...
namespace ISPan2023.DramasCommentsArea.SqlDataLayer
{
	public class SqlParameterBuilder
	{
		...
		{
			var parameter = new SqlParameter(name, SqlDbType.Int, value) { Value = value };
			_parameters.Add(parameter);

			return this;
		}
		public SqlParameterBuilder AddTinyInt(string name, byte value)
		{
			var parameter = new SqlParameter(name, SqlDbType.TinyInt, value) { Value = value };
			_parameters.Add(parameter);
		...
		public SqlParameterBuilder AddDate(string name, DateTime value)
		{
			var parameter = new SqlParameter(name, SqlDbType.Date) { Value = value };
			_parameters.Add(parameter);
